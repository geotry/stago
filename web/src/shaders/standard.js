...
const createUniforms = (gl, program) => {
  const locs = {
    ...
    [`u_dir_light_shadow_map`]: gl.getUniformLocation(program, "u_dir_light_shadow_map"),
  ...
  const u_dir_light_shadow_map = {
    /**
     * Set the value of uniform `u_dir_light_shadow_map`.
     *
     * @param {number} value
     */
    set(value) {
      gl.uniform1i(locs[`u_dir_light_shadow_map`],value);
    },
    /**
     * Returns the value of uniform `u_dir_light_shadow_map`.
     *
     * @returns {number}
     */
    get() {
      return gl.getUniform(program, locs[`u_dir_light_shadow_map`]);
    },
